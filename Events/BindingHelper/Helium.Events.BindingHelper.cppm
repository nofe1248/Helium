...
public:
    ...
    {
        return this->event_listener_.listenToDynamicIDEvent(event_id, std::move([callback](PythonEvent const &event) -> void { callback(event); }));
    }
