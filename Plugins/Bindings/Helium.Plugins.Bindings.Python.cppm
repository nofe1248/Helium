...
PYBIND11_EMBEDDED_MODULE(helium, m)
{
    ...
    py::class_<events::RCONStarted>(events_module, "RCONStartedEvent").def(py::init<>(), py::call_guard<py::gil_scoped_release>());
